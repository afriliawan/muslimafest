...
class Mahasiswa extends CI_Controller{
    ...
    function index(){
        ...
        $codeUnique = 'JEyS1G10010';
        $image_name=$codeUnique.'.png'; //buat name dari qr code sesuai dengan nim
        $allData = 'testtt';
        $params['data'] = "JEyS1G10010"; //data yang akan di jadikan QR CODE
